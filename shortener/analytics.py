...
"aggregates reflect a click within ``flush_interval`` seconds" (default 2s,
satisfying the revised 5-second requirement). Recording never raises — if the
...
class AnalyticsSink:
    DEFAULT_FLUSH_INTERVAL = 2.0  # seconds; the visibility contract bound
